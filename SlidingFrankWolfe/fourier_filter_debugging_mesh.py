            ...
            for j in range(len(meshes[i])):
                ...
                for x in range(function_grid.shape[0]):
                    for y in range(function_grid.shape[1]):
                        ...
                        if (rectangle_polygon.contains(point) or rectangle_polygon.boundary.contains(point)) and (triangle_polygon.contains(point) or triangle_polygon.boundary.contains(point)):
