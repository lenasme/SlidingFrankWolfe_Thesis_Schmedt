...
def sliding_step(u,  target_function_f, reg_param):
	...
	result = minimize( fun = u.objective_wrapper_sliding, x0 = initial_parameters, args =(target_function_f, reg_param),jac = u.gradient_wrapper_sliding, bounds =bounds, options={'gtol': 1e-6,'maxiter': 10000, 'disp': True }, callback = callback)
#method='L-BFGS-B'
